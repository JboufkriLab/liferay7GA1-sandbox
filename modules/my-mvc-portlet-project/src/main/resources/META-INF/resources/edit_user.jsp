...
User selUser = themeDisplay.getUser(); //PortalUtil.getSelectedUser(request);
...
//LiferayPortletURL editPortalActionURL = PortletURLFactoryUtil.create(request, "com_liferay_my_account_web_portlet_MyAccountPortlet", plid, PortletRequest.ACTION_PHASE);
//editPortalActionURL.setParameter(ActionRequest.ACTION_NAME,"/users_admin/edit_user");
//editPortalActionURL.setParameter("mvcRenderCommandName","updateUser");
%>
...
<portlet:actionURL name="updateUser" var="editUserActionURL" >
